            ...
            <NavbarNav center className="categories">
              <NavItem>
                <Dropdown className="dropdown-meu-item">
                  <DropdownToggle nav>Graphics and Design</DropdownToggle>
              ...
              <NavItem>
                <Dropdown className="dropdown-meu-item">
                  <DropdownToggle nav>Writing and Translation</DropdownToggle>
                  <DropdownMenu className="drop-down-menu">
                    <div>
                      <DropdownItem href="#">
              ...
              <NavItem>
                <Dropdown className="dropdown-meu-item">
                  <DropdownToggle nav>Video and Animation</DropdownToggle>
                  <DropdownMenu className="drop-down-menu">
                    <div>
                      <DropdownItem href="#">
              ...
              <NavItem>
                <Dropdown className="dropdown-meu-item">
                  <DropdownToggle nav>Music and Audio</DropdownToggle>
                  <DropdownMenu className="drop-down-menu">
                    <div>
              ...
              <NavItem>
                <Dropdown className="dropdown-meu-item">
                  <DropdownToggle nav>Programming and Tech</DropdownToggle>
                  <DropdownMenu className="drop-down-menu">
                    <div>
              ...
              <NavItem>
                <Dropdown className="dropdown-meu-item">
                  <DropdownToggle nav>Fun and Lifestyle</DropdownToggle>
                  <DropdownMenu className="drop-down-menu">
                  <div>
                      ...
                      <DropdownItem href="#">Health, Nutrition & Fitness</DropdownItem>
                    ...
                    <div>
                      <DropdownItem href="#">Greeting Cards & Videos</DropdownItem>
                      <DropdownItem href="#">
                      Your Message On...
                      </DropdownItem>
                      <DropdownItem href="#">Viral Videos</DropdownItem>
                      <DropdownItem href="#">Pranks & Stunts</DropdownItem>
                      <DropdownItem href="#">Celebrity Impersonators</DropdownItem>
